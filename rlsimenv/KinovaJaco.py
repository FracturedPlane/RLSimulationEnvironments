...
class KinovaJacoOnTable(Environment):
    """
        Cassie walk env
    """
    
    def __init__(self, settings):
        super(KinovaJacoOnTable,self).__init__(settings)
        self._GRAVITY = -9.8
    ...
    def init(self):
        ...
        self._agent = p.loadURDF(RLSIMENV_PATH + "/rlsimenv/data/kinova/jaco_on_table.urdf",[0,0,0.8], useFixedBase=False)
...
if __name__ == "__main__":
    ...
    settings = {"state_bounds": [[0],[1]],
                ...
                "control_substeps": 10}
    sim = KinovaJacoOnTable(settings)
    sim.init()
