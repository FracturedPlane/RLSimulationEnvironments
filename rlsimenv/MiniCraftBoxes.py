...
class MiniCraftBoxes(Environment):
    """Implements gym.Env"""
    count = 0
    ...
    def __init__(self,
        ...
        super(MiniCraftBoxes, self).__init__()
...
class MiniCraftBoxesPartiallyObserved(MiniCraftBoxes):
...
class MiniCraftBoxesFullyObserved(MiniCraftBoxes):
    def __init__(self, **kwargs):
        kwargs.update({'render_shape':(128, 128, 3),
                       'observation_shape':(64, 64, 3),
                       'map_width':4,
